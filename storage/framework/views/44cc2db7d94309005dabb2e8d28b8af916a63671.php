				...
				<div class="container">
					<div class="main-section-data">
						<div class="row">
							<div class="col-lg-3">
                                ...
                                <?php else: ?>
 			                         <img  src="<?php echo e(url('/').'/storage/app/'.$data['user_info'][0]->photo); ?>"   alt="">
                                <?php endif; ?>
												</div>
											</div><!--username-dt end-->
										...
										<ul class="user-fw-status">
											<li>
												<h4>Following</h4>
												<span><?php echo e($data['user_info']['following']); ?></span>
											</li>
											<li>
												<h4>Followers</h4>
												<span><?php echo e($data['user_info']['followers']); ?></span>
											</li>
											<li>
												<a href="<?php echo e(url('/').'/profile'); ?>" title="">View Profile</a>
											</li>
										</ul>
									</div>
                                    <!--User end-->
                    ...
                    <?php    $encrypted_user = Crypt::encryptString("$user->id") ;?>
                                           ...
                                           <img id="myphoto" style="width:50px;height:50px"  src="<?php echo asset('profile_prop/images/default.jpg')  ?>"alt="">
                                            <?php else: ?>
                                            <img id="myphoto" style="width:50px;height:50px"  src="<?php echo e(url('/').'/storage/app/'.$user->photo); ?>"alt="">
                                             <?php endif; ?>									
                                  ...
                                  <?php if(App\lib\Users::FollowExist(Auth::id(),$user->id)==1){?>
										<li onclick="paysar(this)" data="<?php echo e($encrypted_user); ?>"><a id="ff" href="#" title="" class="followw">Unfollow</a></li>
                                         <?php }else{ ?>
                                         <li onclick="paysar(this)" data="<?php echo e($encrypted_user); ?>"><a id="ff" href="#" title="" class="followw">Follow</a></li>
                                       ...
                                       <?php }  ?>                                                        
													...
													<a href="<?php echo e(url('/')); ?>/profile/<?php echo e($encrypted_user); ?>" title="">View Profile</a>
												</div><!--user-profy end-->
...
<?php echo $__env->make('profile_propreties.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Edocs\resources\views/profile_propreties/home.blade.php ENDPATH**/ ?>