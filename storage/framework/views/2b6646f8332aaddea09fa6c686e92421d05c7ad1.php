                    ...
                    <?php    $encrypted = Crypt::encryptString("$user->id") ;?>
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="company_profile_info">
								<div class="company-up-info">
                                       <?php if(is_null($user->photo)): ?>
                                           <img id="myphoto" src="<?php echo asset('profile_prop/images/default.jpg')  ?>"alt="">
                                            <?php else: ?>
                                            <img id="myphoto"src="<?php echo e(url('/').'/storage/app/'.$user->photo); ?>"alt="">
                                             <?php endif; ?>									<h3><?php echo e($user->name); ?></h3>
									<h4>Ensa Tnager</h4>
									<ul>
                                        <?php if(App\lib\Users::FollowExist(Auth::id(),$user->id)==1){?>
										<li onclick="parser(this)" data="<?php echo e($encrypted); ?>"><a id="ff" href="#" title="" class="follow">Unfollow</a></li>
                                         <?php }else{ ?>
                                         <li onclick="parser(this)" data="<?php echo e($encrypted); ?>"><a id="ff" href="#" title="" class="follow">Follow</a></li>
								...
								<a href="<?php echo e(url('/')); ?>/profile/<?php echo e($encrypted); ?>." title="" class="view-more-pro">View Profile</a>
...
<?php echo $__env->make('profile_propreties.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Edocs\resources\views/profile_propreties/profiles.blade.php ENDPATH**/ ?>