      ...
      <div  class="file"  >
        <div  class="file__name" >
          <p id="fileName">DZADZADZ.pdf</p>
				...
				</div><a href="#" title=""><i class="la la-times-circle-o"></i></a>
</div></div><!--post-project-fields end-->
...
<?php echo $__env->make('profile_propreties.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homepages/42/d841511542/htdocs/DocsSmartEnsa/E/resources/views/profile_propreties/UserProfile.blade.php ENDPATH**/ ?>