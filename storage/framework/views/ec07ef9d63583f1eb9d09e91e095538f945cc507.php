									...
									<form method="POST" action="<?php echo e(route('login')); ?>" >
										...
										<div class="row">
											<div class="col-lg-12 no-pdd">
												<div class="sn-field">
													<input  type="email" placeholder="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus class="form-control <?php $__errorArgs = ['email'];
...
</html><?php /**PATH C:\xampp\htdocs\laravel\Edocs\resources\views/profile_propreties/signup.blade.php ENDPATH**/ ?>