            ...
            <div class="container-fluid">
                <div class="menu-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div class="header-btns d-none d-lg-block f-right">
                        <a href="<?php echo e(route('register')); ?>" class="btn header-btn">Sign Up</a>
                    </div>
                    <!-- Mobile Menu -->
                    <div class="col-12">
...
<?php /**PATH C:\xampp\htdocs\laravel\Edocs\resources\views/home_propreties/layout.blade.php ENDPATH**/ ?>