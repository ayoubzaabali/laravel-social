...
<!--COVER SECTION START -->
		<section class="cover-sec" style="height: 100%">
			...
			<img id="cov-img" style="height:350px;"  src="<?php echo asset('profile_prop/images/resources/cover-img.jpg')  ?>"   alt="">
            <?php else: ?>
 			<img id="cov-img" style="height:400px;background-size:cover"  src="<?php echo e(url('/').'/storage/app/'.$data['user_info'][0]->cover); ?>"   alt="">
            <?php endif; ?>
			<div class="add-pic-box">
				<div class="container">
					<div class="row no-gutters">
						<div class="col-lg-12 col-sm-12" <?php echo e($data['hide']); ?>>					
									...
									<div class="user_profile">
										...
										<div class="user-pro-img">
                                           ...
                                           <img id="myphoto" src="<?php echo asset('profile_prop/images/default.jpg')  ?>"alt="">
                                            <?php else: ?>
                                            <img id="myphoto"src="<?php echo e(url('/').'/storage/app/'.$data['user_info'][0]->photo); ?>"alt="">
                                             <?php endif; ?>
                                        
											<div class="add-dp" id="OpenImgUpload" <?php echo e($data['hide']); ?> >
										...
										<div class="user_pro_status">
											<ul class="flw-status">
												<li>
													<span>Following</span>
													<b><?php echo e($data['user_info']['following']); ?></b>
												</li>
												<li>
													<span>Followers</span>
													<b><?php echo e($data['user_info']['followers']); ?></b>
												</li>
											</ul>
                    ...
                    <?php    $encrypted_event = Crypt::encryptString("$event->id") ;?>
											...
											<div class="suggestion-usd">
												...
												<div class="sgt-text">
													...
													<h4><?php echo e($event->titre); ?></h4>
													<span><b>Followers :</b> <?php echo e($event->count); ?></span>
												</div>
												<span><a href="<?php echo e(url('/')); ?>/Event/<?php echo e($encrypted_event); ?>"><i class="la la-plus"></i></a></span>
											</div>
							...
							<div class="col-lg-6">
								<div class="main-ws-sec">
									<div class="user-tab-sec rewivew">
										<h3><?php echo e($data['user_info'][0]->name); ?></h3>
									...
									<div class="product-feed-tab current" id="feed-dd">
                                        							<div class="post-topbar" <?php echo e($data['hide']); ?>>
										<div class="user-picy">
								...
								<div class="right-sidebar">
									<div class="message-btn">
                                      <?php $enc= Crypt::encryptString($data['user_info'][0]->id) ; ?>
										...
										<li onclick="parsar(this)" data="<?php echo e($enc); ?>" ><a  title=""><i class="fas fa-user-plus"></i>Unfollow</a>
                                         <?php else: ?>
                                        <li  onclick="parsar(this)" data="<?php echo e($enc); ?>" ><a  title=""><i class="fas fa-user-plus"></i>Follow</a>
                                        <?php endif; ?>
                                        </li>
                                        </ul>
	...
	<div class="post-popup pst-pj">
			<div class="post-project">
				...
				<div class="post-project-fields">
					<form method="POST" action="<?php echo e(route('addDoc')); ?>"  enctype="multipart/form-data" >
                            <?php echo csrf_field(); ?>
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="inp-field">
									<select required name="event">
                                       <option selected disabled>List of Events Available For you</option>
										...
										<option value="<?php echo e($events->id); ?>" ><?php echo e($events->titre); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
							</div>
...
<div class="post-popup job_post">
			<div class="post-project">
				<h3>Post an Event</h3>
				<div class="post-project-fields">
					<form method="POST" action="<?php echo e(route('addEvent')); ?>"  enctype="multipart/form-data" >
                        <?php echo csrf_field(); ?>
...
<div id="FileUpload">
  <div class="wrapper2">
          ...
          <p id="fileName">DZADZADZ.pdf</p>
                ...
                function loadDoc222(dat) {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if(myres['val']=="OK"){
                            document.getElementById("myphoto").setAttribute("src","<?php echo e(url('/')); ?>"+"/storage/app/"+myres['path']);
                            console.log("<?php echo e(url('/')); ?>"+"/storage/app/"+myres['path']);
                        }
                       }
                      }
                ...
                function loadDoc555(dat) {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        var myres=JSON.parse(this.response);
                        if(myres['val']=="OK"){
                            document.getElementById("cov-img").setAttribute("src","<?php echo e(url('/')); ?>"+"/storage/app/"+myres['path']);
                            console.log("<?php echo e(url('/')); ?>"+"/storage/app/"+myres['path']);
                        }
                       }
                      }
                    ...
                    xhttp.open("POST", "<?php echo e(url('/')); ?>"+"/sendCover");
                    xhttp.send(formData);
            ...
            function parsar(dat){
                    ...
                    // window.open("<?php echo e(url('/')); ?>"+"/unfollow/"+data+"/1");
                     if(fan=="Follow"){
                       loadDoc(dat);  
                     }else{
    ...
    function loadDoc(dat) {
                    ...
                    xhttp.open("GET", "<?php echo e(url('/')); ?>"+"/follow/"+data, true);
                    xhttp.send();
                    }
            ...
            function loadDoc2(dat,test) {
                    ...
                    xhttp.open("GET", "<?php echo e(url('/')); ?>"+"/unfollow/"+data+"/"+test, true);
                    xhttp.send();
                    }
...
<?php echo $__env->make('profile_propreties.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Edocs\resources\views/profile_propreties/UserProfile.blade.php ENDPATH**/ ?>