                                       ...
                                       <?php   $usr_id = Crypt::encryptString("$notif->user_id") ;
										...
										<div style="cursor:pointer;  " class="notfication-details" >
							  				<div class="noty-user-img"> 
                                                ...
                                                <?php else: ?>
							  					<img  src="<?php echo e(url('/').'/storage/app/'.$notif->usphoto); ?>" alt="">
                                                <?php endif; ?>
							  				</div>
							  				<div  class="notification-info">

							  					<h3><a href="<?php echo e(url('/').'/profile/'.$usr_id); ?>" title=""><?php echo e($notif->usname); ?></a> Uploaded a <a href="<?php echo e(url('/').'/Doc/'.$dc_id); ?>">document</a> on <a href="<?php echo e(url('/').'/Event/'.$ev_id); ?>" title=""><?php echo e($notif->titre); ?></a> on <a ><?php echo e($notif->date_creation); ?></a>
                                                     <?php if($notif->new==0): ?>
...
<?php echo $__env->make('profile_propreties.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Edocs\resources\views/profile_propreties/notifications.blade.php ENDPATH**/ ?>