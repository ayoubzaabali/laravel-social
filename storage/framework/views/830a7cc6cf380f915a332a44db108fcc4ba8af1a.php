            ...
            <div class="container-fluid">
                <div class="menu-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div class="main-menu f-right d-none d-lg-block">
                        <nav>
                            <ul id="navigation">
                                ...
                                <li><a href="<?php echo e(Route('about'), false); ?>">About</a></li>
                                <li><a href="<?php echo e(Route('services'), false); ?>">Services</a></li>
                                <li><a href="<?php echo e(Route('gallery'), false); ?>">Gallery</a></li>
                    ...
                    <div class="header-btns d-none d-lg-block f-right">
                        <a href="<?php echo e(route('register'), false); ?>" class="btn header-btn">Sign Up</a>
                    </div>
                    <!-- Mobile Menu -->
                    <div class="col-12">
...
<?php /**PATH /homepages/7/d421602321/htdocs/ENT/DOCS20/E/resources/views/home_propreties/layout.blade.php ENDPATH**/ ?>