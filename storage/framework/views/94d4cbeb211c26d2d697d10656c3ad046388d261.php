									...
									<div class="user-tab-sec rewivew">
										...
										<div class="star-descp">
											...
											<ul>
												...
												<li data-tab="info-dd">
													<a href="#" title="">
														<img src="<?php echo asset('profile_prop/images/ic2.png')  ?>" alt="">
														<span>Info</span>
													</a>
												</li>
								...
								<div class="right-sidebar">
                                    ...
                                    <div class="message-btn">
                                      <?php $enc= Crypt::encryptString($data['event_info'][0]->id) ; ?>
										...
										<li onclick="purse(this)" data="<?php echo e($enc, false); ?>" ><a  title=""><i class="fas fa-user-plus"></i>Unfollow</a>
                                        <?php else: ?>
                                        <li onclick="purse(this)" data="<?php echo e($enc, false); ?>" ><a  title=""><i class="fas fa-user-plus"></i>Pending..</a>
                                        <?php endif; ?>>
...
<?php echo $__env->make('profile_propreties.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homepages/7/d421602321/htdocs/ENT/DOCS20/E/resources/views/profile_propreties/Event_home.blade.php ENDPATH**/ ?>