		...
		<header>
			<div class="container">
				<div class="header-data">
					<div class="logo">
						<a href="<?php echo e(url('/'), false); ?>" title=""><img src="<?php echo asset('profile_prop/images/letterE.png')  ?>"  alt=""></a>
					</div><!--logo end-->
              ...
              <li>
              <a  href="<?php echo e(url('/'), false); ?>/events" title="">
...
<script type="text/javascript">
  ...
  //  xhttp.send();
    ...
    function CreateElement(myjson){
        ...
        <?php /**PATH C:\xampp\htdocs\social\resources\views/profile_propreties/layout.blade.php ENDPATH**/ ?>